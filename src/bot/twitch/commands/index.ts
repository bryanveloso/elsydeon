...
export const commands: BotCommand[] = [punt, slap, quote, analyze, stats, ffrefresh, heykay, heymoral, heymyri]

// Export individual commands for direct use
export { punt, slap, quote, analyze, stats, ffrefresh, heykay, heymoral, heymyri }
